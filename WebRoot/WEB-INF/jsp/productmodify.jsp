								...
								<form id="productForm" name="productForm" method="post"
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="hidden" id="ct2" value="${product.categoryLevel2Id}" vv="${product.p2Name}">
												<select name="categoryLevel2Id" id="categoryLevel2Id"
													class="form-control border-input">
												</select> <font color="red"></font>
											</div>
											<div class="col-sm-3">
												<input type="hidden" id="ct3" value="${product.categoryLevel3Id}" vv="${product.p3Name}">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<textarea name="description" id="description" rows="5"
												class="form-control border-input" value="${product.description}"></textarea>
										</div>
									</div>
									<div class="row">
										<div class="form-group">
